...
import { IExecuteContext, INodeExecutionData, INodeTypeDescription, ITelegramCredential } from '../lib/types';
...
export class TelegramNode extends BaseNode {
  ...
  async execute(context: IExecuteContext): Promise<INodeExecutionData[][]> {
    ...
    const credential  = (await context.getCredentials('telegramApi')) as unknown as ITelegramCredential;
